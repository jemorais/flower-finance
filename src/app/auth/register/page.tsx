...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-50 via-white to-purple-50 p-4">
      <Card className="w-full max-w-md bg-white border-pink-200 shadow-lg hover:shadow-xl transition-all duration-300">
        <CardHeader className="space-y-1">
          ...
          <CardTitle className="text-2xl text-center text-pink-800">Criar Conta</CardTitle>
          <CardDescription className="text-center text-pink-600">
            Preencha os dados para criar sua conta na Flower Finance
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-6 pt-6 border-t">
            <div className="text-center">
              <p className="text-sm text-muted-foreground mb-3">Ou continue com</p>
