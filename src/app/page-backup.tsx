...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-rose-50 to-purple-50">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              ...
              <a href="#contact" className="text-gray-700 hover:text-pink-600 transition-colors">Faça seu pedido</a>
              <Link href="/dashboard">
      ...
      <section className="py-20 px-6 hero-background" style={{ backgroundImage: 'url(/images/flowers/hero-background.jpg)', backgroundSize: 'cover' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in-up">
              ...
              <div className="flex flex-col sm:flex-row gap-4 animate-slide-up-delay-3">
                <Button size="lg" className="ripple-button bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white px-8 py-3 hover:scale-105 hover:shadow-lg transition-all duration-300 animate-pulse-subtle">
                  <Heart className="w-5 h-5 mr-2 animate-bounce-subtle" />
                  Fazer Pedido
                </Button>
                <Button size="lg" variant="outline" className="ripple-button border-pink-300 text-pink-600 hover:bg-pink-50 px-8 py-3 hover:scale-105 hover:shadow-md transition-all duration-300">
                  Ver Catálogo
                </Button>
              </div>
            </div>
      ...
      <ScrollReveal delay={200}>
        <section id="services" className="py-20 px-6 bg-white/50">
          <div className="max-w-7xl mx-auto">
            <ScrollStagger staggerDelay={200} startDelay={100}>
            ...
            <ScrollReveal delay={400}>
              <div className="mb-16">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                  <Card className="service-card group hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-br from-pink-50 to-rose-50">
                <CardHeader>
                ...
                <CardContent>
                  ...
                  <ScrollStagger staggerDelay={150} startDelay={600}>
                    <div className="grid grid-cols-2 gap-4">
          ...
          <div className="mb-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <Card className="service-card group hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-br from-purple-50 to-pink-50 lg:order-2 stagger-item" data-delay="500">
                <CardHeader>
                  <div className="w-16 h-16 bg-gradient-to-br from-pink-500 to-rose-500 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                    <Gift className="w-8 h-8 text-white fill-current" />
                  </div>
          ...
          <div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <Card className="service-card group hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-br from-rose-50 to-purple-50 stagger-item" data-delay="600">
                <CardHeader>
                  <div className="w-16 h-16 bg-gradient-to-br from-pink-500 to-rose-500 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                    <Flower className="w-8 h-8 text-white fill-current" />
                  </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative overflow-hidden stagger-item" data-delay="300">
            <div className="testimonials-slider-continuous">
              ...
              <div className="flex testimonials-carousel">
                {/* First set of testimonials */}
                <div className="flex-shrink-0 w-full">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-4">
                    <Card className="border-0 shadow-lg bg-gradient-to-br from-pink-50 to-white hover:shadow-xl transition-all duration-300 stagger-item" data-delay="400">
                    ...
                    <Card className="border-0 shadow-lg bg-gradient-to-br from-purple-50 to-white hover:shadow-xl transition-all duration-300 stagger-item" data-delay="500">
                      <CardContent className="p-6">
                        <div className="flex items-center mb-4">
                          {[1, 2, 3, 4, 5].map((star) => (
                            <Star key={star} className="w-5 h-5 text-yellow-400 fill-current" />
                    ...
                    <Card className="border-0 shadow-lg bg-gradient-to-br from-rose-50 to-white hover:shadow-xl transition-all duration-300 stagger-item" data-delay="600">
                      <CardContent className="p-6">
                        <div className="flex items-center mb-4">
                          {[1, 2, 3, 4, 5].map((star) => (
                            <Star key={star} className="w-5 h-5 text-yellow-400 fill-current" />
                ...
                <div className="flex-shrink-0 w-full">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-4">
                    <Card className="border-0 shadow-lg bg-gradient-to-br from-emerald-50 to-white hover:shadow-xl transition-all duration-300 stagger-item" data-delay="700">
                      <CardContent className="p-6">
                        <div className="flex items-center mb-4">
                          {[1, 2, 3, 4, 5].map((star) => (
                            <Star key={star} className="w-5 h-5 text-yellow-400 fill-current" />
                    ...
                    <Card className="border-0 shadow-lg bg-gradient-to-br from-blue-50 to-white hover:shadow-xl transition-all duration-300 stagger-item" data-delay="800">
                      <CardContent className="p-6">
                        <div className="flex items-center mb-4">
                          {[1, 2, 3, 4, 5].map((star) => (
                            <Star key={star} className="w-5 h-5 text-yellow-400 fill-current" />
                    ...
                    <Card className="border-0 shadow-lg bg-gradient-to-br from-amber-50 to-white hover:shadow-xl transition-all duration-300 stagger-item" data-delay="900">
                      <CardContent className="p-6">
                        <div className="flex items-center mb-4">
                          {[1, 2, 3, 4, 5].map((star) => (
                            <Star key={star} className="w-5 h-5 text-yellow-400 fill-current" />
                ...
                <div className="flex-shrink-0 w-full">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-4">
                    <Card className="border-0 shadow-lg bg-gradient-to-br from-pink-50 to-white hover:shadow-xl transition-all duration-300 stagger-item" data-delay="1000">
                      <CardContent className="p-6">
                        <div className="flex items-center mb-4">
                          {[1, 2, 3, 4, 5].map((star) => (
                            <Star key={star} className="w-5 h-5 text-yellow-400 fill-current" />
                    ...
                    <Card className="border-0 shadow-lg bg-gradient-to-br from-purple-50 to-white hover:shadow-xl transition-all duration-300 stagger-item" data-delay="1100">
                      <CardContent className="p-6">
                        <div className="flex items-center mb-4">
                          {[1, 2, 3, 4, 5].map((star) => (
                            <Star key={star} className="w-5 h-5 text-yellow-400 fill-current" />
                    ...
                    <Card className="border-0 shadow-lg bg-gradient-to-br from-rose-50 to-white hover:shadow-xl transition-all duration-300 stagger-item" data-delay="1200">
                      <CardContent className="p-6">
                        <div className="flex items-center mb-4">
                          {[1, 2, 3, 4, 5].map((star) => (
                            <Star key={star} className="w-5 h-5 text-yellow-400 fill-current" />
      ...
      {/* Contact Section */}
      <section id="contact" className="py-20 px-6 bg-gradient-to-br from-pink-50 via-rose-50 to-purple-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
                ...
                <form className="space-y-6">
                  ...
                  <div className="border-b border-gray-200 pb-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="stagger-item" data-delay="400">
                      ...
                      <div className="stagger-item" data-delay="500">
                  ...
                  <div className="border-b border-gray-200 pb-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg-grid-cols-3 gap-4">
                      <div className="stagger-item" data-delay="600">
                      ...
                      <div className="stagger-item" data-delay="700">
                      ...
                      <div className="sm:col-span-2 lg:col-span-1 stagger-item" data-delay="800">
                  ...
                  <div className="border-b border-gray-200 pb-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                      <div className="stagger-item" data-delay="900">
                      ...
                      <div className="stagger-item" data-delay="1000">
                    ...
                    <div className="stagger-item" data-delay="1100">
                  ...
                  {/* Observações */}
                  <div className="stagger-item" data-delay="1200">
                    <h4 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                  ...
                  <div className="stagger-item" data-delay="1300">
                    <Button 
                      type="submit" 
      ...
      {/* Footer */}
      <footer className="bg-gray-900 text-white py-16 px-6 stagger-item" data-delay="1400">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="stagger-item" data-delay="1500">
            ...
            <div className="stagger-item" data-delay="1600">
            ...
            <div className="stagger-item" data-delay="1700">
            ...
            <div className="stagger-item" data-delay="1800">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center stagger-item" data-delay="1900">
